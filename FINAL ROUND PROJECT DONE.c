    ...
    do
    {
...

        {
            ...
            /* printf("_______________________________________________\n");
             printf("|    Name   |   ID    |     Greade   |  CGPA  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Shaon     |  1028   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Nabil     |  1036   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Siam      |  1123   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Mubarak   |  1027   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Nayeem    |  1849   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("|Asaduzzaman|  1233   |      A+      |  4.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Shahriar  |  1259   |      A       |  3.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Abrar     |  1269   |      A       |  3.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Limon     |  1283   |      A       |  3.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Tamim     |  1285   |      A       |  3.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Joy       |  1185   |      A       |  3.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Sami      |  1921   |      A-      |  3.50  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Golam     |  1119   |      A-      |  3.50  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Nibir     |  1343   |      A-      |  3.50  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Aupam     |  1525   |      B+      |  3.25  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Tonmoy    |  1037   |      B       |  3.00  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Sherin    |  1212   |      B-      |  2.75  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Hasib     |  1195   |      C+      |  2.50  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Kibria    |  1653   |      C       |  2.25  |\n");
             printf("|-----------|---------|--------------|--------|\n");
             printf("| Sakib     |  1266   |      F       |  0.00  |\n");
             printf("|___________|_________|______________|________|\n");*/
        ...
        if(press==4)
        {
            int grades[] = {80,80,80,80,80,80,75,75,75,75,75,70,70,69,64,59,54,49,33};
            int numStudents = sizeof(grades) / sizeof(grades[0]);

            int gradeCount[10] = {0}; // Initialize the count array with zeros
